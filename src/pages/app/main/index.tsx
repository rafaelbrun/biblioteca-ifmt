		...
		<View style={styles.container}>
			...
			<View style={styles.inputContainer}>
				<View style={styles.inputField}>
					<AntDesign style={styles.marginInput} name='search1' size={24} color='black' />
					<TextInput style={[styles.marginInput, styles.fullWidth]} onSubmitEditing={() => handlePesquisar(filterText)}
						onChangeText={text => { setFilterText(text) }} placeholder='Pesquisar livro' value={filterText} />
					{filterText != '' ?
						<Feather onPress={handleClearSearch} style={styles.marginInput} name="x" size={18} color="red" />
						:
						<View></View>}
					<AntDesign style={styles.marginInput} name='arrowright' size={24} color={skyBlue} onPress={() => { handlePesquisar(filterText) }} />
				</View>
			</View>
