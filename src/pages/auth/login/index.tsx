...
import { View, Text, ScrollView, Alert, ActivityIndicator, TouchableHighlight, TouchableWithoutFeedback, Image, Keyboard } from 'react-native';
						...
						<View style={styles.inputContainer}>
							<View style={styles.fieldInput}>
								...
								<TextInput keyboardType='numeric' autoCapitalize='none' style={styles.textInput}
									onChangeText={inputMatricula => setMatricula(inputMatricula)} maxLength={15}></TextInput>
							</View>
							<View style={styles.fieldInput}>
								<Text style={styles.footerText}>Senha</Text>
								<TextInput secureTextEntry={true} onChangeText={inputSenha => setSenha(inputSenha)}
									autoCapitalize='none' style={styles.textInput} maxLength={20}></TextInput>
							</View>
							<TouchableHighlight style={styles.loginButton} onPress={handleLogar}>
